...
public class Avgmarks {
  public static void main(String[] args) {
   Scanner sc=new Scanner(System.in);
	...
	System.out.println("Enter Subject A marks of student "+(i+1));
	System.out.println("Enter Subject B marks of student "+(i+1));
	System.out.println("Enter Subject C marks of student "+(i+1));
	for(int j=0;j<3;j++) {
	data[i][j]=sc.nextInt();
	}
   }
